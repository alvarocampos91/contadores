...
return [
    ...
    */
    ...
    |
    */
    'model-namespace' => 'App\Models\Contador',
    ...
    */
    'resources' => [
        'co-folios-usuarios'           => \App\Models\Contador\CoFoliosUsuario::class,
        'co-venta-movimientos'         => \App\Models\Contador\CoVentaMovimiento::class,
        'co-folios-movimientos'        => \App\Models\Contador\CoFoliosMovimiento::class,
        'co-documento-movimientos'     => \App\Models\Contador\CoDocumentoMovimiento::class,
        'co-documento-nits-asociados'  => \App\Models\Contador\CoDocumentoNitsAsociado::class,
        'co-folios-historial-usuarios' => \App\Models\Contador\CoFoliosHistorialUsuario::class,
    ],
